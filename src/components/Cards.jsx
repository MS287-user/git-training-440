        ...
        <>
            <div className='cards-container grid md:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-10 md:p-20 p-10'>
                {cardsData.map((cardData) => (
                    <div className='card border border-blue-300 shadow-lg hover:scale-105 transition-transform ease-in-out duration-300' key={cardData.card_id}>
                        <div className='card-img'>
                            <img src={cardData.card_img} alt="" />
                        </div>
                        <div className='card-text p-3'>
                            <div className='flex justify-between items-center relative'>
                                <h2 className='text-lg font-bold'>{cardData.card_title}</h2>
                            ...
                            <p className='text-sm'>{cardData.card_description}</p>
                        </div>
                    </div>
                ))}
